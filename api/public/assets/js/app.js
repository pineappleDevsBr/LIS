...
/* harmony import */ var _modules_ajax__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/ajax */ "./resources/assets/js/modules/ajax.js");
...
_modules_ajax__WEBPACK_IMPORTED_MODULE_3__["default"].create('[data-ajax]');
...
var success = '<div class="m-3 sufee-alert alert with-close alert-success alert-dismissible fade show"><span class="badge badge-pill adge-success">Success</span>You successfully read this important alert.<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';
var failed = '<div class="m-3 sufee-alert alert with-close alert-danger alert-dismissible fade show"><span class="badge badge-pill badge-danger">Success</span>You successfully read this important alert.<button type="button" class="close" data-dismiss="alert" ria-label="Close"><span aria-hidden="true">×</span></button></div>';

function ajax(elm) {
  var URL = elm.getAttribute('action');
  var method = elm.getAttribute('method');
  var submit = elm.querySelector('[type=submit]');
  ...
  function _doRequest() {
    _doRequest = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var formData;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  create: function create(selector) {
    var elms = Array.from(document.querySelectorAll(selector));
...
/* harmony import */ var _template_listening__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./template/listening */ "./resources/assets/js/modules/questions/template/listening.js");
/* harmony import */ var _template_reading__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./template/reading */ "./resources/assets/js/modules/questions/template/reading.js");
/* harmony import */ var _template_newsletter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./template/newsletter */ "./resources/assets/js/modules/questions/template/newsletter.js");
/* harmony import */ var _radios__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../radios */ "./resources/assets/js/modules/radios.js");
...
var templates = {
  ...
  listening: _template_listening__WEBPACK_IMPORTED_MODULE_2__["default"],
  reading: _template_reading__WEBPACK_IMPORTED_MODULE_3__["default"],
  newsletter: _template_newsletter__WEBPACK_IMPORTED_MODULE_4__["default"]
};
...
function questions(elm) {
  ...
  btn.addEventListener('click', function () {
    if (idx <= config.count) {
      ...
      _radios__WEBPACK_IMPORTED_MODULE_5__["default"].init(template);
...
/***/ "./resources/assets/js/modules/questions/template/listening.js":
/*!*********************************************************************!*\
  !*** ./resources/assets/js/modules/questions/template/listening.js ***!
  \*********************************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function (idx) {
  var template = "\n    <li class=\"list-group-item rounded border mb-2 border-info\" data-questions-item=\"\">\n      <p>Question #".concat(idx, "</p>\n      <div class=\"form-group d-flex align-items-center\">\n        <label for=\"file_").concat(idx, "\" class=\"flex-grow-0 control-label mb-1 mr-2\">file*</label>\n        <input id=\"file_").concat(idx, "\" name=\"audio[]\" type=\"file\" class=\"flex-grow-1 form-control\" accept=\"audio/*\" aria-required=\"true\"\n          aria-invalid=\"false\" required>\n      </div>\n      <div class=\"form-group d-flex align-items-center\">\n        <label for=\"asnwer_").concat(idx, "\" class=\"flex-grow-0 control-label mb-1 mr-2\">asnwer*</label>\n        <input id=\"answer_").concat(idx, "\" name=\"questions[").concat(idx, "].answer\" type=\"text\" class=\"form-control\">\n      </div>\n    </li>\n  ");
  return new DOMParser().parseFromString(template, 'text/html').body.firstChild;
});

/***/ }),

/***/ "./resources/assets/js/modules/questions/template/newsletter.js":
/*!**********************************************************************!*\
  !*** ./resources/assets/js/modules/questions/template/newsletter.js ***!
  \**********************************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function (idx) {
  var template = "\n  <li class=\"list-group-item rounded border mb-2 border-info\" data-questions-item=\"\" data-validation-item=\"\">\n    <div class=\"row\">\n      <div class=\"col form-group\">\n        <label for=\"text-".concat(idx, "\" class=\"control-label mb-1\">Text</label>\n        <input id=\"text-").concat(idx, "\" name=\"payload.items[").concat(idx, "].text\" type=\"text\" class=\"form-control\" aria-required=\"true\"\n          aria-invalid=\"false\" required>\n      </div>\n    </div>\n    <div class=\"row\">\n      <div class=\"col form-group\">\n        <label for=\"image-").concat(idx, "\" class=\"control-label mb-1\">Image</label>\n        <select name=\"payload.items[").concat(idx, "].image\" id=\"image-").concat(idx, "\" class=\"form-control\" required>\n          <option value=\"\">Select</option>\n          <option value=\"flag\">Flag</option>\n          <option value=\"timeline\">Timline</option>\n        </select>\n      </div>\n    </div>\n  </li>\n  ");
  return new DOMParser().parseFromString(template, 'text/html').body.firstChild;
});
...
/***/ "./resources/assets/js/modules/questions/template/reading.js":
/*!*******************************************************************!*\
  !*** ./resources/assets/js/modules/questions/template/reading.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function (idx) {
  var template = "\n    <li class=\"list-group-item rounded border mb-2 border-info\" data-questions-item=\"\">\n      <p>Question #".concat(idx, "</p>\n      <div class=\"form-group d-flex align-items-center\">\n        <label for=\"asnwer_").concat(idx, "\" class=\"flex-grow-0 control-label mb-1 mr-2\">answer*</label>\n        <input id=\"answer_").concat(idx, "\" name=\"questions[").concat(idx, "].question\" type=\"text\" class=\"form-control\">\n      </div>\n      <div class=\"form-group d-flex align-items-center\">\n        <label for=\"text_").concat(idx, "\" class=\"flex-grow-0 control-label mb-1 mr-2\">text*</label>\n        <textarea id=\"text_").concat(idx, "\" name=\"questions[").concat(idx, "].text\" type=\"file\" class=\"flex-grow-1 form-control\" aria-required=\"true\"\n        aria-invalid=\"false\" required></textarea>\n      </div>\n    </li>\n  ");
  return new DOMParser().parseFromString(template, 'text/html').body.firstChild;
});
...
module.exports = __webpack_require__(/*! /home/novahaus-dev/projects/lis/api/resources/assets/js/app.js */"./resources/assets/js/app.js");
